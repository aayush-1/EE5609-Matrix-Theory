...
\begin{align}
\myvec{4 & 3} \vec{x} = c\_1 
\\
\myvec{4 & 3} \vec{x} = c\_2
\end{align}

These c1 and c2 can be easily found by evaluating the distance between the parallel lines:
\begin{align}
\frac{(\mid c - 12 \mid)}{\sqrt{4^{2} + 3^{2}}} = 4
\end{align}


The equation of the parallel lines in terms of the given line is then obtained as

\begin{align}
\myvec{4 & 3} \vec{x} = 12 \pm\norm{\myvec{3 & 4}}4
\\
\myvec{4 & 3} \vec{x} = 12 \pm(\sqrt{4^{2} + 3^{2}})4
\end{align}
...
PLOT: 
\newline
\includegraphics[width=10cm,height=8cm]{Figure_1.png}
\end{document}